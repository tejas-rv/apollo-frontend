...
export default function ServiceReportHistory() {
  ...
  async function downloadPdf(reportId) {
    ...
    try {
      ...
      a.href = url;
      a.download = `ServiceReport-${reportId}.pdf`;
      a.click();
    ...
    <section className="page">
      <div className="page-head">
        <div>
          ...
          <h1>My Reports</h1>
          <p className="muted">All service reports you have submitted.</p>
        </div>
                ...
                reports.map((r) => {
                  ...
                  return (
                    <tr key={r.id}>
                      ...
                      <td>
                        <span
                          className={`status ${STATUS_CLASS[r.status] || "pending"}`}
                        >
                          {STATUS_LABEL[r.status] || r.status}
                        </span>
                      </td>
                      <td>
                        <span style={{ color: "#217746", fontWeight: 600 }}>
                          ✔{yesCount}
                        </span>
                        {" / "}
                        <span style={{ color: "#a33838", fontWeight: 600 }}>
                          ✘{noCount}
                        </span>
