...
export default function ServiceReportForm() {
    ...
    async function loadChecklist() {
        ...
        try {
            ...
            setChecklist(
                items.map((i) => ({
                    ...i,
                    answerChoice: null, // "Yes" | "No" | "Not Applicable" | null
                    answerText: "",
                })),
            );
            setStep("checklist");
    ...
    const chooseAnswer = useCallback((idx, choice) => {
        // choice is one of "Yes" | "No" | "Not Applicable"
        setChecklist((prev) => {
            const next = [...prev];
            next[idx] = {
                ...next[idx],
                ...
                checkItems: checklist.map((i) => ({
                    ...
                    answer:
                        i.answerType === "YES_NO" || i.answerType === "YES_NO_NA"
                            ? i.answerChoice // "Yes" | "No" | "Not Applicable" | null
                            : null,
                          ...
                          >
                            {item.itemOrder}.
                                                ...
                                                <div style={{display: "flex", gap: 6, flexShrink: 0}}>
                                                    ...
                                                    <button
                                                        onClick={() => chooseAnswer(idx, "Not Applicable")}
                                                        style={{
                                                            padding: "6px 14px",
                                                            borderRadius: 7,
                                                            border: "1px solid",
                                                            ...
                                                            cursor: "pointer",
                                                            background:
                                                                item.answerChoice === "Not Applicable"
                                                                    ? "#e8eef6"
                                                                    : "#f5f5f5",
                                                            borderColor:
                                                                item.answerChoice === "Not Applicable"
