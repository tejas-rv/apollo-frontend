...
import {LayoutDashboard,Users,FileText,Send,ShieldCheck,LogOut,Menu,Receipt} from "lucide-react";
...
function Shell({children,user}) {
  ...
  return <div className="app-shell">
    <aside className={open?"sidebar":"sidebar collapsed"}>
      <div className="brand"><img src="/apollo-logo.svg" alt="Apollo" className="brand-mark" style={{objectFit:"contain"}}/>{open&&<div><b>APOLLO</b><span>Elevators</span></div>}</div>
...
export default function App(){
 ...
 return <Routes>
  ...
  <Route path="*" element={<Protected><Shell user={user}><Routes>
   ...
   <Route path="/customers/:id/edit" element={<CustomerForm/>}/><Route path="/bills" element={<Bills/>}/>
